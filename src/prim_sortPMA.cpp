...
/*
    ...
    using sortPMA technique.
*/

/*

    Algorithm : SortPMA algorithm
    Input: G(V, E) : An undirected weighted graph, with the
    list of adjacent edges of each vertex sorted by weight;
    Last : Last minimum outgoing edge found for each
    vertex. Q : the list of vertices in the current sub-tree;
    Output: The lightest edge e(u, v) such that u ∈ Q and
    v not ∈ Q
    1 minW = ∞ ;
